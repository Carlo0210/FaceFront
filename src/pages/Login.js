      ...
      if (data) {
        ...
        switch (userType) {
          ...
          case "Event Monitoring":
            ...
            break;
          default:
            navigate("/dashboard"); // Navigate to the dashboard by default
            break;
        }
      }
    });
        ...
        <Col md={7} className="d-flex align-items-center justify-content-center flex-direction-column">
          <Form style={{ width: "80%", maxWidth: 500 }} onSubmit={handleLogin}>
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <h1 style={{ textAlign: "center" }}>Welcome Login</h1>
            ...
            <button className="lbutton" style={{ width: "100%", height: "100%", borderRadius: "25px" }} variant="primary" type="submit">
